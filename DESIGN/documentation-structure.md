...
- Is it for me?
- What is its status — usable, in development, abandoned?
- How do I install or try it?
...
- **Content documents** — one focused topic per file. Kebab-case filenames (`reader-api.md`, `error-hierarchy.md`).
...
- **Filename:** kebab-case, descriptive, stable (`reader-api.md`, not `notes-2026-05.md`).
...
- **Cross-references:** link to other design documents using relative paths (`[reader api](reader-api.md)`), and to root-level files with a leading slash (`[CLAUDE.md](../CLAUDE.md)`).
